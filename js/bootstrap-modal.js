...
! function(e) {
    ...
    function i(t) {
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            this.$backdrop = e('<div class="modal-backdrop animated FadeIn ' + r + '" />').appendTo(document.body);
    ...
    function o() {
        ...
        if (this.isShown && this.options.keyboard) {
            e(document).on("keyup.dismiss.modal", function(e) {
                e.which == 27 && t.hide()
            })
...
! function(e) {
    ...
    t.prototype = {
        ...
        process: function() {
            var e = this.$scrollElement.scrollTop() + 82 + this.options.offset,
